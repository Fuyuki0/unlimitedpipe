...
count hashtags in 10-minute windows and report the ones rising far above their recent average.
...
```bash
unlimited run bluesky AI LLM --lang en -- extract words -- count --by words --every 10m -- trend
```
